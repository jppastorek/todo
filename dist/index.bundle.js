...
class Controller {
    ...
    addTask(title, dueDate, priority) {
      this.taskList.push(new _task_js__WEBPACK_IMPORTED_MODULE_0__.Task(title, (0,date_fns_format__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(date), 'MM/dd/yyyy'), priority, false));
    }
...
const view = new _view_js__WEBPACK_IMPORTED_MODULE_1__.View(controller, document.body)
view.buildPage();
